...
class CausesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cause" do
    assert_difference('Cause.count') do
      post causes_url, params: { cause: { company: @cause.company, description: @cause.description, destiny: @cause.destiny, origin: @cause.origin, problem: @cause.problem } }
    end
  ...
  test "should update cause" do
    patch cause_url(@cause), params: { cause: { company: @cause.company, description: @cause.description, destiny: @cause.destiny, origin: @cause.origin, problem: @cause.problem } }
